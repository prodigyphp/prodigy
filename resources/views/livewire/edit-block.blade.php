            ...
            <x-prodigy::editor.h2 class="pro-px-2 pro-flex">
                <div class="pro-flex-grow"
                    ...
                    <div class="pro-flex" x-show="is_global && !locally_editing_title">
                        <div class="pro-flex-grow">
                            {{ $block->global_title }}
                            <button x-on:click="locally_editing_title = true" class="hover:pro-text-blue-500 pro-relative pro-top-1 pro-left-1">
                    ...
                    <div class="pro-flex pro-gap-2" x-show="is_global && locally_editing_title">
                        ...
                        <x-prodigy::editor.button x-on:click="locally_editing_title = false" class="pro-min-w-[120px]">
                            {{ _('Set Title') }}
