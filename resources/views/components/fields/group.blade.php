...
<div class="pro-w-full" x-data="{ expanded: true }">
    <div @click="expanded = ! expanded" class=" mb-2 pro-border-t-8 pro-border-gray-200 px-2 pt-4">
        <svg :class="{ 'pro--rotate-90': !expanded }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="pro-w-5 pro-h-5 pro-inline-block pro-mr-1 pro-transform pro-transition">
