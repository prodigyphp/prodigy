                ...
                <div class="pro-group pro-pt-4">
                    ...
                    <div class="pro-grid pro-grid-cols-2 pro-mb-4">
                        @foreach($blocks->where('group', $group['slug']) as $block)
                            <div
                                    draggable="true"
                                    ondragstart="event.dataTransfer.setData('text/plain', 'blocks.header');"
                                    class="hover:pro-bg-white pro-flex-grow hover:pro-border-gray-100 hover:pro-shadow-sm pro-rounded-sm pro-transition pro-cursor-grab pro-px-2 pro-py-2">
                                {{ $block['title'] }}
                            </div>
                        @endforeach
                    </div>
